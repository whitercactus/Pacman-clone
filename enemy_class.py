...
class Enemy:
    ...
    def update(self):
        ...
        self.grid_pos.x = (self.pix_pos.x-TOP_BOTTOM_BUFFER +
                            self.app.cell_width//2)//self.app.cell_width+1
        self.grid_pos.y = (self.pix_pos.y-TOP_BOTTOM_BUFFER +
    ...
    def get_path_direction(self, target):
        ...
        xdir = next_cell[0] - self.grid_pos.x
        ydir = next_cell[1] - self.grid_pos.y
