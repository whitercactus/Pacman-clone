...
class App:
    ...
    def load_data(self):
        ...
        with open(os.path.join(self.file,hs_file), "r") as f:
            try:
...
############################ HELPER FUNCTIONS ##################################
    ...
    def reset(self,score,lives):
        ...
        self.player.current_score = score
...
########################### INTRO FUNCTIONS ####################################
    ...
    def start_draw(self):
        ...
        self.draw_text('HIGH SCORE: ' + str(self.highscore), self.screen, [4, 0],
...
########################### PLAYING FUNCTIONS ##################################
    ...
    def playing_events(self):
        ...
        if len(self.coins) == 0:
            self.reset(self.player.current_score,self.player.lives)
    ...
    def playing_draw(self):
        ...
        self.draw_text('HIGH SCORE: ' + str(self.highscore), self.screen, [WIDTH//2+60, 0], 18, WHITE, START_FONT)
        if self.player.current_score > self.highscore:
            self.highscore = self.player.current_score
            with open(os.path.join(self.file,hs_file), "w") as f:
